...
Unlimited_loop_test_for_lift () {
    ...
    then
        ...
        if [ $? -eq 0 ]; then
            sudo /opt/butler_server/erts-11.1.3/bin/escript /usr/lib/cgi-bin/rpc_call.escript butler_test_functions test_butler_loop_start "[$1, [{\""$2"\",$3},{'up'},{\""$4"\",$5},{'down'},{\""$4"\",$5},{'up'},{\""$2"\",$3},{'down'}]]."
            echo "<br>"
            echo "OK Done...."
        else
